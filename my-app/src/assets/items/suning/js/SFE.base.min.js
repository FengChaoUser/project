...
SFE.base = function(a) {
		...
		q = function(c) {
			...
			if (d) "function" == typeof c && c(d);
				...
				var g = /^(\w*)(pre)(\w*)(.cnsuning.com)$/,
					...
					l = "http://ipservice.suning.com";
				g.test(j) ? l = "http://ipservicepre.cnsuning.com" : h.test(j) ? l = "http://ipservicesit.cnsuning.com" : i.test(j) && (l = "http://ipservicesit.cnsuning.com");
				var m = l + "/ipQuery.do";
				a.ajax({
					type: "GET",
					url: m,
	...
	var D = function() {
		...
		O = function() {
			function b() {
				...
				0 == j ? k = n.offset().top + p + b : "", q > 660 && !h && (sn.isHome || sn.hasTopFixed) && (i > k ? c() : d(), j = i > k ? !0 : !1), k >= i && (d(), j = !1), 0 == j ? "" : SFE.search.clearBox()
			}
		...
		Q = function() {
			var b = i(document.location.hostname),
				c = "",
				d = {};
			L() && (c = "prd" == b ? "http://msg.suning.com/mms-web/" : "http://msg" + b + ".cnsuning.com/mms-web/", a.ajax({
				...
				success: function(b) {
					b && b.status && b.status > 0 && (a(".ng-bar-node-msg .dot").show(), a(".ng-msg-child .ng-msg-list").html('<a class="ng-msg-item" name="public0_none_dbgjt_wdxx02" href="' + (b.msgUrl || "http://msg.suning.com/") + '" target="_blank" unread="true"><i></i><span>' + b.msgInfo + "</span></a>"), d = b)
				}
	...
	SFE.base.toolBarEvent(), SFE.search.searchEvent(), SFE.base.allSort(), SFE.base.fixEvent(), SFE.base.footerLazyLoad(), $("a[name^=public0_],input[name^=public0_]").live("click", function() {
...
$(function(){	
		...
		// 鼠标经过右侧
	    var lc = $('.sn-sidebar-tab-finance');
	    var l  = $('#l');
	    lc.hover(function() {
		lc.addClass("sn-sidebar-tab-hover");
		l.animate({left:'-47px'},300);
	    },function(){
		lc.removeClass("sn-sidebar-tab-hover")
		l.animate({left:'0px'},300);
	    });
	    
	    var zj = $('.sn-sidebar-tab-history');
	    var z  = $('#z');
	    zj.hover(function() {
		zj.addClass("sn-sidebar-tab-hover");
		z.animate({left:'-47px'},300);
	    },function(){
		zj.removeClass("sn-sidebar-tab-hover")
		z.animate({left:'0px'},300);
	    });
	    
	    var qd = $('.sn-sidebar-tab-sign');
	    var q  = $('#q');
	    qd.hover(function() {
		qd.addClass("sn-sidebar-tab-hover");
		q.animate({left:'-47px'},300);
	    },function(){
		qd.removeClass("sn-sidebar-tab-hover")
		q.animate({left:'0px'},300);
	    });
	    
	    var zxzx = $('#sn-sidebar-change-service');
	    var zx  = $('#zx');
	    zxzx.hover(function() {
		zxzx.addClass("sn-sidebar-tab-hover");
		zx.animate({left:'-73px'},300);
	    },function(){
		zxzx.removeClass("sn-sidebar-tab-hover")
		zx.animate({left:'0px'},300);
	    });
	    
	    var yjfk = $('#sn-sidebar-change-feedback');
	    var yj  = $('#yj');
	    yjfk.hover(function() {
		yjfk.addClass("sn-sidebar-tab-hover");
		yj.animate({left:'-73px'},300);
	    },function(){
		yjfk.removeClass("sn-sidebar-tab-hover")
		yj.animate({left:'0px'},300);
	    });
	    
	    var fhdb = $('.sn-sidebar-to-top');
	    var fh  = $('#fh');
	    fhdb.hover(function() {
		fhdb.addClass("sn-sidebar-tab-hover");
		fh.animate({left:'-73px'},300);
	    },function(){
		fhdb.removeClass("sn-sidebar-tab-hover")
		fh.animate({left:'0px'},300);
	    });
	    
	    var ewm = $('.sn-sidebar-code');
	    var m  = $('#sn-sidebar-change-code');
	    ewm.hover(function() {
		ewm.addClass("sn-sidebar-tab-hover");
		m.css('display','block');
		m.animate({left:'-131px'},300);
	    },function(){
		ewm.removeClass("sn-sidebar-tab-hover")
		m.animate({left:'0px'},300);
	    });  
