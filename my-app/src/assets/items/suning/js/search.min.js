...
SFE.search = (function($) {
	...
	var searchInputEvent = function() {
		...
		obj.focus(function() {
			...
			if (value == "") {
				searchFlag = false;
				obj.val(searchDefaultKeyword).css({
					color: "#CCC"
				})
			}
		})
	...
	var searchHisKeyword = function() {
		...
		$.ajax({
			url: daMain + "his/" + userId + "---searchHis.jsonp",
			dataType: "jsonp",
			jsonpCallback: "searchHis",
			success: function(data) {
	...
	var searchAutoComplete = function() {
		...
		var autoComplateFun = function(keyword) {
			...
			timer = setTimeout(function() {
				...
				var daMain = dsservice();
				$.ajax({
					url: daMain + "his/" + userId + "-" + encodeURIComponent(resolveHisKey(keyword)) + "-" + getSearchCategoryId() + "-autoComplateCallback.jsonp",
					dataType: "jsonp",
